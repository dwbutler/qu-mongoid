...
describe Qu::Backend::Mongoid do
  ...
  describe 'connection' do
    it 'uses a separate connection in each thread' do
      ...
      expect(separate_connection).to be_true
    end
    ...
    it 'has a configurable session that works with threads' do
      ...
      expect(should_have_qu_session_in_new_thread).to be_true
    ...
    it 'uses MONGOHQ_URL from heroku' do
      ...
      expect(subject.connection.cluster.nodes.first.resolved_address).to eq("127.0.0.1:27017")
